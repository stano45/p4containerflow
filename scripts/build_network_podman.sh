...
sudo podman run -d --name iperf-server1 --pod h1-pod docker.io/redis
...
sudo podman run -d --name iperf-server2 --pod h2-pod docker.io/redis
...
sudo podman run -d --name iperf-server3 --pod h3-pod docker.io/redis
...
sudo podman run -d --name iperf-server4 --pod h4-pod docker.io/redis
